  ...
  return (
    <Link href={servicePath(service.slug)} className="group block h-full">
      <InteractiveCard className="h-full">
        <Card className="flex h-full min-h-[31rem] flex-col transition duration-[220ms] ease-out group-hover:border-white/20 group-hover:bg-white/[0.05]">
          <div className="mb-6 flex items-center justify-between gap-4">
            <span className="grid h-11 w-11 place-items-center rounded-md bg-[var(--page-accent,#6ee7b7)]/12 text-[var(--page-secondary,#a7f3d0)] transition-colors duration-[220ms] ease-out group-hover:bg-[var(--page-accent,#6ee7b7)]/16">
              <Icon className="h-5 w-5" aria-hidden="true" />
            </span>
            <ArrowRight className="h-4 w-4 text-slate-500 transition-colors duration-[220ms] ease-out group-hover:text-slate-200" />
          </div>
  ...
  return (
    <InteractiveCard className="h-full" beam={recommended ? "always" : "hover"}>
      <Card className="flex h-full min-h-0 flex-col p-5">
        ...
        <p className="mt-4 rounded-md border border-[var(--page-accent,#6ee7b7)]/20 bg-[var(--page-accent,#6ee7b7)]/10 px-3 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--page-secondary,#a7f3d0)]">
